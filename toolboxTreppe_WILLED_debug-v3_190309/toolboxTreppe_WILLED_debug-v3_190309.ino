...
#define MAX_LAENGE 800 //maximal Sensor Range in cm
    ...
    if(SerialS.read()==HEADER)//assess data package frame header 0x59
    {
      ...
      if(SerialS.read()==HEADER)//assess data package frame header 0x59
      {
        ...
        if(uart[8]==(check&0xff))//verify the received data as per protocol
        {
          ...
          leuchte = ((dist-30)/difflaenge*NUM_LEDS/10);
          if(leuchte <NUM_LEDS)
...
void animation() {
  ...
  //leds[ XY(4, gegenstrecke)] = CHSV( 255, 255, 255 );
  //leds[ XY(5, leuchte)] = CHSV( hue, 255, 255 );
  //leds[ XY(6, gegenstrecke)] = CHSV( 255, 255, 255 );
  //leds[ XY(5, 2)] = CHSV( hue, 255, 255 );
  Serial.println(XY(5, 2));
  Serial.println(XY(5, 5));
  Serial.println(XY(5, 7));
  //leds[ XY(5, 5)] = CHSV( hue, 255, 255 );
  //leds[ XY(5, 7)] = CHSV( hue, 255, 255 );
